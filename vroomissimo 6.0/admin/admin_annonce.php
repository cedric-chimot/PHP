...
if (isset($_POST['ajout_annonce'])) {
    ...
    if (mysqli_num_rows($select_num_annonce) > 0) {
        ...
        (num_annonce, idvendeur, vendeur, marque, modele, prix, Km, annee_circul, annee_production, carburant, carrosserie, etat, description, contact_vendeur, image)
        VALUES('$num_annonce', '$admin_id', '$vendeur', '$marque', '$modele', '$prix', '$km', '$circulation', '$production', '$carburant',
