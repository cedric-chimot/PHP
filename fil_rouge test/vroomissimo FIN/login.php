...
if (isset($_POST['submit'])) {
    ...
    if (mysqli_num_rows($select_user) > 0) {
        ...
        //si c'est un client il est redirigé vers le tableau de bord
...
<body>
    ...
    <div class="form-container">
        ...
        <form action="" method="post">
            ...
            <p>Vous voulez faire des achats ? <a href="inscrire.php">S'inscrire</a></p>
            <p>Vous voulez vendre sur notre site ? <a href="admin/inscrire_vendeur.php">S'inscrire</a></p>
        </form>
