...
if (isset($_GET['delete'])) {
    ...
    //renvoie vers la page d'administration des admins
...
<body>
    ...
    <section class="users">
        ...
        <h1 class="titre">Comptes d'administrateurs</h1>

        <div class="box-container">

            <?php
            //on va chercher dans la BDD tous les utilisateurs avec le statut admin
                $select_users = mysqli_query($con, "SELECT * FROM `admin`
            ...
            // Récupère la ligne suivante d'un ensemble de résultats sous forme de tableau associatif
                ...
                <div class="box">
                    ...
                    <a href="admin_admins.php?delete=<?php echo $fetch_users['admin_id']; ?>" class="delete-btn"
                        onclick="return confirm('Voulez-vous supprimer cet admin ?');">Supprimer</a>
                </div>
            <?php
            };
            ?>
