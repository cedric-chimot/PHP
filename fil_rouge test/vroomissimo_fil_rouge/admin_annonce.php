...
if (isset($_GET['delete'])) {
    ...
    $delete_image_query = mysqli_query($con, "SELECT image FROM `annonce` WHERE id = '$delete_id'")
        or die('Echec de la requête');
    $fetch_delete_image = mysqli_fetch_assoc($delete_image_query);
    mysqli_query($con, "DELETE FROM `annonce` WHERE id = '$delete_id'")
        or die('Echec de la requête');
        ...
        <div class="box-container">
            ...
            ?>
                    <div class="box">
                        ...
                        <a href="admin_annonce.php?update_annonce=<?php echo $fetch_annonces['id']; ?>" class="btn">Modifier l'annonce</a>
                        <a href="admin_annonce.php?delete=<?php echo $fetch_annonces['id']; ?>" class="delete-btn" onclick="return confirm('Voulez-vous supprimer cette annonce ?');">Supprimer l'annonce</a>
                    </div>
            <?php
                }
            } else {
