...
if (isset($_POST['submit'])) {
    ...
    if (mysqli_num_rows($select_vendeur) > 0) {
        ...
        if ($password != $cpassword) {
            ...
            mysqli_query($con, "INSERT INTO `vendeur`(nom, adresse, cp, ville, pays, email, password, type_user)
...
<body>
    ...
    <div class="form-container">
        ...
        <form action="" method="post">
            ...
            <p>Vous possédez déjà un compte ? <a href="login_vendeur.php">Se connecter</a></p>
        </form>
