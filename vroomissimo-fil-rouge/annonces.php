...
if (isset($_POST['ajout_panier'])){
    ...
    if(mysqli_num_rows($check_panier_nombre) > 0){
        ...
        mysqli_query($con, "INSERT INTO `panier`(client_id, num_annonce, marque, modele, prix, quantite, image)
        VALUES ('$client_id', $num_annonce, '$annonce_marque', '$annonce_modele', '$annonce_prix', '$annonce_quantite', '$annonce_image')")
        or die('Echec de la requête');
