...
if(isset($_POST['update_membre'])){
    ...
    $update_membre_id = htmlspecialchars($_POST['update_membre_id']);
    $update_nom = htmlspecialchars($_POST['update_nom']);
    $update_adresse = htmlspecialchars($_POST['update_adresse']);
    $update_cp = htmlspecialchars($_POST['update_cp']);
    $update_ville = htmlspecialchars($_POST['update_ville']);
    $update_pays = htmlspecialchars($_POST['update_pays']);
