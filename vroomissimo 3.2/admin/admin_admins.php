        ...
        <div class="box-container">
            ...
            // Récupère la ligne suivante d'un ensemble de résultats sous forme de tableau associatif
                ...
                <div class="box">
                    ...
                    <a href="admin_users.php?delete=<?php echo $fetch_users['ID']; ?>" class="delete-btn"
                        onclick="return confirm('Voulez-vous supprimer cet utilisateur ?');">Supprimer l'utilisateur
                    </a>
                </div>
            <?php
            };
