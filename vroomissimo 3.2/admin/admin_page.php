    ...
    <section class="dashboard">
        ...
        <div class="box-container">
            ...
            <div class="box">
                ...
                <a href="admin_commandes.php" class="btn">Les commandes</a>
            </div>
            ...
            <div class="box">
                ...
                <a href="admin_users.php" class="btn">Voir les inscrits</a>
            </div>
            ...
            <div class="box">
                ...
                <a href="admin_contact.php" class="btn">Voir les messages</a>
            </div>
